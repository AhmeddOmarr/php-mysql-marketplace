...
CREATE TABLE IF NOT EXISTS `rentals` (
  ...
  CONSTRAINT `rentals_ibfk_2` FOREIGN KEY (`renter_id`) REFERENCES `accounts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE ratings (
  ...
  FOREIGN KEY (rated_by_id) REFERENCES accounts(id) ON DELETE CASCADE,
  FOREIGN KEY (rated_id) REFERENCES accounts(id) ON DELETE CASCADE,
  FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE
);
